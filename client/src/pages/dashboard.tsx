...
import { Bell, Plus, Calendar, Syringe } from "lucide-react";
    ...
    <div className="mobile-container">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-green-100 text-sm">
              {user?.firstName ? `${user.firstName} ${user.lastName || ''}`.trim() : user?.email || 'Pet Owner'}
            </p>
          </div>
      ...
      <div className="p-4 pb-20">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500">Book vet visits & checkups</p>
                </div>
              </button>
              ...
              <button className="w-full flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500">Manage vaccine schedules</p>
                </div>
              </button>
            </div>
          </CardContent>
        ...
        {overdueReminders.length > 0 && (
          <Card className="mt-4 border-destructive bg-red-50">
            <CardContent className="p-4">
